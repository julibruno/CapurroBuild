...
$sendingAccountUsername     = 'capurrobuildweb@gmail.com';
$sendingAccountPassword     = '123Capurro'; 

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'info@capurrobuild.com.ar';// REQUIRED value.
$recipientName              = 'Capurro Build';             // REQUIRED value.
$recipientEmailBcc          = 'lh@posicionando.com.ar';// REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'Mensaje Web'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'CapurroBuild.com.ar';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'Argentina/Buenos Aires';         // OPTIONAL, but some servers require this to be set. 
